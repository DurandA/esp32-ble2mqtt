 ...
 */
static void gps_on_event(void *event_handler_arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
	ESP_LOGW(TAG, "gps_event_handler2");
    gps_t *gps = NULL;
    switch (event_id) {
    case GPS_UPDATE:
